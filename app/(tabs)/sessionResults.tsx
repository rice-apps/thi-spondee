    ...
    <View style={styles.container}>
      ...
      <View style={{flex: 0.25, justifyContent: "center"}}>
        ...
        <View style={{flex: 1, width: "28%", flexDirection: "row", justifyContent: "space-between"}}>
          ...
          <Image source={require('../../assets/images/gray_dot.png')}
                 style={{width: 10, height: 10, marginTop: 23, marginHorizontal: 10}}/>
          <Text style={styles.grayTextStyle}>
            November 1, 2024
          </Text>
        </View>
        ...
        <View style={{width: "40%"}}>
          <View style={{
            ...
            <View style={{flexDirection: "row", width: "70%", justifyContent: "space-between"}}>
              <Text style={styles.blackTextStyle}>Set Size: 4 </Text><Text style={styles.blackTextStyle}>Sound:
              On</Text>
            </View>
          </View>
            ...
            <View style={{width: "100%", flexDirection: "row", justifyContent: "space-between"}}>
              ...
              <TouchableOpacity>
                <Image source={require('../../assets/images/edit_icon.png')}
                       style={{width: 22, height: 22, marginTop: 3, marginLeft: 118}}/>
              </TouchableOpacity>
            </View>
